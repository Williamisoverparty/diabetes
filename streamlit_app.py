...
if page == "Introduction 📘":
    ...
    rows = st.slider("Select a number of rows to display",5,50,5)
    ...
    with tab3:
        ...
        user_selection = st.multiselect("Select the variables that you want for the corr matrix",corr_df.columns, default=corr_df.columns)
    ...
    st.info("Automated profiling is disabled due to package compatibility issues.")
